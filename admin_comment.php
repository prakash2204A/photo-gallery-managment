...
<title>Comment</title>
    ...
    <style type="text/css">
        ...
        body {
                ...
                height: 100%;
                width: 100%;
                background: url(pictures/blurred-room.jpg) no-repeat fixed;
                ...
                $table = 'user';
                       ...
                       /* if (!mysqli_connect($db_host, $db_user, $db_pwd))
                        ...
                        if (!mysqli_select_db($database))
                            ...
                            $database_name = 'online_art_gallery'; // Replace with your actual database name
                            
                            if (!mysqli_select_db($connection, $database)) {
                                die('Could not select the database: ' . mysqli_error($connection));
                            }
